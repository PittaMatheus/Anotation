...
public class CalculadoraServico {
    ...
    public ResultadoRequisicao somar(@ParametroRequisicao(nome = "numero1", obrigatorio = true) int numero1, @ParametroRequisicao(nome = "numero2", padrao = "10") int numero2) {
        ...
        resultadoRequisicao.addDado("resultado", numero1 + numero2);
        resultadoRequisicao.setCaminhoRelativoRecursoRetorno("/resultado.jsp");
        return resultadoRequisicao;
    }
    
    @RecursoWeb(recurso = "/subtrair", metodo = MetodoHTTP.POST)
    public ResultadoRequisicao subtrair(@ParametroRequisicao(nome = "numero1", obrigatorio = true) int numero1, @ParametroRequisicao(nome = "numero2", padrao = "10") int numero2) {
        ResultadoRequisicao resultadoRequisicao = new ResultadoRequisicao();
        resultadoRequisicao.addDado("resultado", numero1 - numero2);
        resultadoRequisicao.setCaminhoRelativoRecursoRetorno("/resultado.jsp");
        return resultadoRequisicao;
